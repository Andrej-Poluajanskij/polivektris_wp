...
<section class="inner-page_header soc-res_page">
    ...
    <div class="inner_page container">
        ...
        <div class="inner_page-image">
            <img src="<?php echo get_correct_image_link_thumb(get_field('content_image'), 'inner-page_content-image'); ?>" >
        </div>
            ...
            <?php foreach( $images as $image_id ): ?>
                <li>
                    <a href="<?php echo get_correct_image_link_thumb($image_id, 'full'); ?>">
                        <img src="<?php echo get_correct_image_link_thumb($image_id, 'responsibility-galery-image'); ?>" >
                    </a>
                </li> 
            <?php endforeach; ?>
            </ul>
